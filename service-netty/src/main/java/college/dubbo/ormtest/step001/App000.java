package college.dubbo.ormtest.step001;

import college.dubbo.ormtest.step001.entity.StudentEntity;
import college.dubbo.ormtest.step001.entity.XxxEntity_Helper;
...
public class App000 {
    ...
    public static void main(String[] args) {
        ...
        while (rs.next()) {
            // 创建新的实体对象
            StudentEntity ue = helper.create(StudentEntity.class, rs);
        }
